...
import { PM_POLL_MS, ODDSAPI_POLL_MS, ODDS_API_KEY, log } from "./config.js";
...
log(`daemon start: PM every ${PM_POLL_MS / 60000}min, OddsAPI every ${ODDSAPI_POLL_MS / 60000}min${ODDS_API_KEY ? "" : " (no key — PM only)"}`);
