...
export const COPY = {
  zh: {
    ...
    heroSub: "AI 辅助的赔率比较、Polymarket 流动性筛选、市场热度发现与风险解释工具。这是市场情报，不是投注推荐。",
    marketPulse: "今日市场脉搏",
    metrics: {
      totalMarkets: "总市场",
      volume24h: "24h 成交额",
    ...
    metricHints: {
      ...
      opportunities: "风险调整后 >= 70",
    },
    sections: {
      hottest: "热门比赛",
      hottestSub: "heat 综合 PM 流动性、成交额、参与和价格移动",
  ...
  en: {
    ...
    signals: "5 signals",
    heroTitle: "World Cup Market Radar",
    heroSub: "AI-assisted odds comparison, Polymarket liquidity screening, market heat discovery, and risk interpretation. This is market intelligence, not a betting recommendation product.",
    marketPulse: "Today's market pulse",
    metrics: {
      ...
      opportunities: "AI Opportunity Count",
    },
    metricHints: {
      ...
      opportunities: "Risk-adjusted >= 70",
    },
    sections: {
      hottest: "Hottest Matches",
      hottestSub: "heat combines PM liquidity, volume, participation, and movement",
